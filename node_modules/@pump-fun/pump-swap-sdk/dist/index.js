...
var PumpAmmInternalSdk = class {
  ...
  async claimPumpIncentivesInternal(user) {
    ...
    return [
      ...
      await this.offlineProgram.methods.claimPumpIncentives().accountsPartial({
        user,
...
var PumpAmmSdk = class {
  ...
  async claimPumpIncentives(user) {
    return this.pumpAmmInternalSdk.claimPumpIncentivesInternal(user);
  }
};
...
var PumpAmmAdminSdk = class {
  ...
  async updatePumpIncentives(admin, startTime, endTime, dayNumber, pumpTokenSupplyPerDay) {
    return this.program.methods.updatePumpIncentives(
      startTime,
      endTime,
      dayNumber.toNumber(),
