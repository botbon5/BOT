...
function sellBaseInputInternal(base, slippage, baseReserve, quoteReserve, globalConfig, coinCreator) {
  ...
  const coinCreatorFee = import_web32.PublicKey.default.equals(coinCreator) ? new import_bn3.default(0) : fee(quoteAmountOut, globalConfig.coinCreatorFeeBasisPoints);
...
function sellQuoteInputInternal(quote, slippage, baseReserve, quoteReserve, globalConfig, coinCreator) {
  ...
  const rawQuote = calculateQuoteAmountOut(
    ...
    import_web32.PublicKey.default.equals(coinCreator) ? new import_bn3.default(0) : globalConfig.coinCreatorFeeBasisPoints
  );
