...
function buyBaseInputInternal(base, slippage, baseReserve, quoteReserve, globalConfig, coinCreator) {
  ...
  const coinCreatorFee = import_web32.PublicKey.default.equals(coinCreator) ? new import_bn3.default(0) : fee(quoteAmountIn, globalConfig.coinCreatorFeeBasisPoints);
