...
type ChainName = 'solana' | 'ethereum' | 'bsc' | 'polygon' | 'avalanche' | 'arbitrum' | 'optimism' | 'base' | 'aptos' | 'sui' | 'unichain' | 'linea' | 'hypercore' | 'sonic';
...
type GetSolanaSwapParams = MctpGetSolanaSwapParams | SwiftGetSolanaSwapParams | HCDepositUSDCGetSolanaSwapParams | MonoChainGetSolanaSwapParams;
...
declare function getEvmSwiftParams(quote: Quote, swapperAddress: string, destinationAddress: string, referrerAddress: string | null | undefined, signerChainId: string | number): EvmSwiftParams;
declare function getSwiftFromEvmTxPayload(quote: Quote, swapperAddress: string, destinationAddress: string, referrerAddress: string | null | undefined, signerChainId: number | string, permit: Erc20Permit | null): TransactionRequest & {
...
declare function getSwiftFromEvmGasLessParams(quote: Quote, swapperAddress: string, destinationAddress: string, referrerAddress: string | null | undefined, signerChainId: number | string, permit: Erc20Permit | null): SwiftEvmGasLessParams;
...
declare function getHyperCoreDepositFromEvmTxPayload(quote: Quote, swapperAddress: string, destinationAddress: string, referrerAddress: string | null | undefined, signerChainId: number | string, permit: Erc20Permit | null, payload: Uint8Array | Buffer | null | undefined, options?: {
    usdcPermitSignature?: string;
}): TransactionRequest & {
    _forwarder: EvmForwarderParams;
};

declare function getMonoChainFromEvmTxPayload(quote: Quote, destinationAddress: string, referrerAddress: string | null | undefined, signerChainId: number | string, permit: Erc20Permit | null): TransactionRequest & {
    _forwarder: EvmForwarderParams;
};

declare function getFastMctpFromEvmTxPayload(quote: Quote, destinationAddress: string, referrerAddress: string | null | undefined, signerChainId: number | string, permit: Erc20Permit | null, payload: Uint8Array | Buffer | null | undefined): TransactionRequest & {
    _forwarder: EvmForwarderParams;
};
...
declare function createMctpBridgeWithFeeInstruction(ledger: PublicKey, toChain: ChainName, mintAddress: string, relayerAddress: string, feeSolana: bigint): {
...
declare function resolveInputCoin(amount: bigint, owner: string, coinType: string, suiClient: SuiClient, tx: Transaction$1, preparedCoin: SuiFunctionParameter): Promise<SuiFunctionNestedResult | TransactionResult | {
    $kind: "Input";
    Input: number;
    type?: "object";
}>;
