...
const useAnnouncements = (items, listContainerRef, inputRef, t0, t1, message) => {
  ...
  const announce = t3;
  let t4;
  if ($[3] !== announce || $[4] !== inputRef.current || $[5] !== items || $[6] !== listContainerRef) {
  ...
  let t5;
  if ($[8] !== announce || $[9] !== inputRef || $[10] !== items || $[11] !== listContainerRef) {
    t5 = [listContainerRef, inputRef, items, liveRegion, announce];
    $[8] = announce;
    $[9] = inputRef;
    $[10] = items;
    $[11] = listContainerRef;
  ...
  let t6;
  if ($[13] !== announce || $[14] !== isFirstRender || $[15] !== items || $[16] !== listContainerRef || $[17] !== loading || $[18] !== (message === null || message === void 0 ? void 0 : message.description) || $[19] !== (message === null || message === void 0 ? void 0 : message.title)) {
  ...
  let t7;
  if ($[21] !== announce || $[22] !== isFirstRender || $[23] !== items || $[24] !== listContainerRef || $[25] !== loading || $[26] !== message) {
    t7 = [announce, isFirstRender, items, listContainerRef, liveRegion, loading, message];
    $[21] = announce;
    $[22] = isFirstRender;
    $[23] = items;
    $[24] = listContainerRef;
