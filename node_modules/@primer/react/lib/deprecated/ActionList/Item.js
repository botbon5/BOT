...
const Item = /*#__PURE__*/React__default.default.forwardRef((itemProps, ref) => {
  ...
  if ($[30] !== selected || $[31] !== selectionVariant || $[32] !== (theme === null || theme === void 0 ? void 0 : theme.colors)) {
    t7 = !!selected === selected && /*#__PURE__*/jsxRuntime.jsx(BaseVisualContainer, {
  ...
  if ($[34] !== LeadingVisual || $[35] !== disabled || $[36] !== variant) {
    t8 = LeadingVisual && /*#__PURE__*/jsxRuntime.jsx(LeadingVisualContainer, {
      variant: variant,
      disabled: disabled,
  ...
  if ($[40] !== labelId || $[41] !== text) {
    t12 = text ? /*#__PURE__*/jsxRuntime.jsx(TextContainer, {
      id: labelId,
      children: text
    }) : null;
    $[40] = labelId;
  ...
  if ($[43] !== description || $[44] !== descriptionId || $[45] !== descriptionVariant || $[46] !== theme) {
    t13 = description ? /*#__PURE__*/jsxRuntime.jsx(DescriptionContainer, {
      id: descriptionId,
      style: {
  ...
  if ($[48] !== children || $[49] !== t11 || $[50] !== t12 || $[51] !== t13) {
    t14 = /*#__PURE__*/jsxRuntime.jsxs(MainContent, {
      style: t11,
  ...
  if ($[53] !== TrailingIcon || $[54] !== TrailingVisual || $[55] !== disabled || $[56] !== trailingText || $[57] !== variant) {
    t15 = TrailingVisual ? /*#__PURE__*/jsxRuntime.jsx(TrailingContent, {
      variant: variant,
      disabled: disabled,
  ...
  let t16;
  if ($[59] !== t14 || $[60] !== t15) {
    t16 = /*#__PURE__*/jsxRuntime.jsxs(DividedContent, {
      children: [t14, t15]
    });
    $[59] = t14;
    $[60] = t15;
  ...
  if ($[62] !== Component || $[63] !== clickHandler || $[64] !== id || $[65] !== keyPressHandler || $[66] !== props || $[67] !== ref || $[68] !== selected || $[69] !== showDivider || $[70] !== t16 || $[71] !== t4 || $[72] !== t5 || $[73] !== t6 || $[74] !== t7 || $[75] !== t8 || $[76] !== variant) {
    t17 = /*#__PURE__*/jsxRuntime.jsxs(StyledItem, {
      ref: ref,
      as: Component,
      tabIndex: t4,
      variant: variant,
