...
const Root = /*#__PURE__*/React__default.default.forwardRef((t0, forwardRef) => {
  ...
  let t3;
  if ($[6] !== className) {
    t3 = clsx.clsx(className, Details_module.Details);
    $[6] = className;
    $[7] = t3;
  } else {
    t3 = $[7];
  ...
  let t4;
  if ($[8] !== hasSummary) {
    t4 = !hasSummary && /*#__PURE__*/jsxRuntime.jsx(Details.Summary, {
...
function Summary(t0) {
  ...
  if ($[4] !== Component || $[5] !== children || $[6] !== props || $[7] !== t1) {
    t2 = /*#__PURE__*/jsxRuntime.jsx(Component, {
      as: t1,
      ...props,
      children: children
    });
