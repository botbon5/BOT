...
const ProgressBar = /*#__PURE__*/React.forwardRef((t0, forwardRef) => {
  const $ = reactCompilerRuntime.c(32);
  let animated;
  let ariaLabel;
  let ariaValueNow;
  ...
  let t3;
  if ($[12] !== children) {
    t3 = React__default.default.Children.toArray(children);
    $[12] = children;
    $[13] = t3;
  } else {
    t3 = $[13];
  ...
  let t4;
  if ($[14] !== className) {
    t4 = clsx.clsx(className, ProgressBar_module.ProgressBarContainer);
    $[14] = className;
    $[15] = t4;
  } else {
    t4 = $[15];
  ...
  if ($[16] !== animated || $[17] !== ariaLabel || $[18] !== ariaValueNow || $[19] !== ariaValueText || $[20] !== bg || $[21] !== children || $[22] !== progress || $[23] !== validChildren) {
    t6 = validChildren ? children : /*#__PURE__*/jsxRuntime.jsx(Item, {
