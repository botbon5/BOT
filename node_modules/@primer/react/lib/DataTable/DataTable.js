...
function DataTable(t0) {
    ...
    if ($[10] !== actions || $[11] !== onToggleSort) {
      t4 = header => {
        if (header.isSortable()) {
          return /*#__PURE__*/jsxRuntime.jsx(Table.TableSortHeader, {
        ...
        return /*#__PURE__*/jsxRuntime.jsx(Table.TableHeader, {
          align: header.column.align,
          children: typeof header.column.header === "string" ? header.column.header : header.column.header()
        }, header.id);
      };
  ...
  let t4;
  if ($[13] !== t3) {
    t4 = /*#__PURE__*/jsxRuntime.jsx(Table.TableHead, {
      children: /*#__PURE__*/jsxRuntime.jsx(Table.TableRow, {
        children: t3
      })
    });
    $[13] = t3;
  ...
  let t6;
  if ($[17] !== t5) {
    t6 = /*#__PURE__*/jsxRuntime.jsx(Table.TableBody, {
      children: t5
    });
    $[17] = t5;
    $[18] = t6;
  ...
  if ($[19] !== cellPadding || $[20] !== describedby || $[21] !== gridTemplateColumns || $[22] !== labelledby || $[23] !== t4 || $[24] !== t6) {
    t7 = /*#__PURE__*/jsxRuntime.jsxs(Table.Table, {
      "aria-labelledby": labelledby,
      "aria-describedby": describedby,
...
function _temp(row) {
  return /*#__PURE__*/jsxRuntime.jsx(Table.TableRow, {
    children: row.getCells().map(cell => /*#__PURE__*/jsxRuntime.jsx(Table.TableCell, {
