...
function Spinner(t0) {
  ...
  if ($[7] === Symbol.for("react.memo_cache_sentinel")) {
    t5 = /*#__PURE__*/jsxRuntime.jsx("circle", {
      cx: "8",
      cy: "8",
      r: "7",
      stroke: "currentColor",
    ...
    t6 = /*#__PURE__*/jsxRuntime.jsx("path", {
  ...
  if ($[9] !== className || $[10] !== props || $[11] !== size || $[12] !== style || $[13] !== t3 || $[14] !== t4) {
    t7 = /*#__PURE__*/jsxRuntime.jsxs("svg", {
      height: size,
      width: size,
      viewBox: "0 0 16 16",
      fill: "none",
  ...
  if ($[16] !== hasHiddenLabel || $[17] !== labelId || $[18] !== srText) {
    t8 = hasHiddenLabel ? /*#__PURE__*/jsxRuntime.jsx(VisuallyHidden.VisuallyHidden, {
      id: labelId,
      children: srText
    }) : null;
    $[16] = hasHiddenLabel;
  ...
  let t9;
  if ($[20] !== t7 || $[21] !== t8) {
    t9 = /*#__PURE__*/jsxRuntime.jsxs("span", {
...
function StyledSpinner(t0) {
  ...
  let t1;
  if ($[3] !== className) {
    t1 = clsx.clsx(className, Spinner_module.SpinnerAnimation);
    $[3] = className;
    $[4] = t1;
  } else {
    t1 = $[4];
