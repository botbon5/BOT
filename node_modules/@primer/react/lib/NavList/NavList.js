...
const Root = /*#__PURE__*/React__default.default.forwardRef((t0, ref) => {
  ...
  let t2;
  if ($[4] !== children) {
    t2 = /*#__PURE__*/jsxRuntime.jsx(ActionListContainerContext.ActionListContainerContext.Provider, {
      value: t1,
...
const Item = /*#__PURE__*/React__default.default.forwardRef((t0, ref) => {
  ...
  if ($[6] !== children || $[7] !== defaultOpen) {
    subNav = React__default.default.Children.toArray(children).find(_temp);
    let t3;
    if ($[11] !== children) {
      t3 = React__default.default.Children.toArray(children).filter(_temp2);
      $[11] = children;
      $[12] = t3;
    } else {
      t3 = $[12];
    ...
    t2 = subNav && /*#__PURE__*/React.isValidElement(subNav);
    $[6] = children;
    $[7] = defaultOpen;
  ...
  if (t2) {
    ...
    if ($[15] !== childrenWithoutSubNavOrTrailingAction || $[16] !== defaultOpen || $[17] !== depth || $[18] !== subNav || $[19] !== sxProp || $[20] !== t4) {
      t5 = /*#__PURE__*/jsxRuntime.jsx(ItemWithSubNav, {
        subNav: subNav,
        depth: depth,
  ...
  if ($[24] !== ariaCurrent || $[25] !== children || $[26] !== props || $[27] !== ref || $[28] !== t3 || $[29] !== t5) {
    t6 = /*#__PURE__*/jsxRuntime.jsx(index.ActionList.LinkItem, {
      ref: ref,
      "aria-current": ariaCurrent,
      active: t3,
      style: t5,
...
const SubNav = /*#__PURE__*/React__default.default.forwardRef((t0, forwardedRef) => {
  ...
  if (sxProp !== defaultSxProp.defaultSxProp) {
    ...
    let t5;
    if ($[8] !== t3 || $[9] !== t4) {
      t5 = /*#__PURE__*/jsxRuntime.jsx(SubNavContext.Provider, {
        value: t3,
        children: t4
      });
      $[8] = t3;
...
const Group = t0 => {
  ...
  if (sxProp !== defaultSx) {
    let t2;
    if ($[5] !== title) {
      t2 = title ? /*#__PURE__*/jsxRuntime.jsx(index.ActionList.GroupHeading, {
        children: title
      }) : null;
      $[5] = title;
      $[6] = t2;
    ...
    if ($[7] !== children || $[8] !== sxProp || $[9] !== t2) {
      t3 = /*#__PURE__*/jsxRuntime.jsxs(Box, {
        sx: sxProp,
        as: "li",
  ...
  if ($[11] === Symbol.for("react.memo_cache_sentinel")) {
    t2 = /*#__PURE__*/jsxRuntime.jsx(index.ActionList.Divider, {});
    $[11] = t2;
  } else {
    t2 = $[11];
  }
  let t3;
  if ($[12] !== title) {
    t3 = title ? /*#__PURE__*/jsxRuntime.jsx(index.ActionList.GroupHeading, {
      as: "h3",
  ...
  if ($[14] !== children || $[15] !== props || $[16] !== t3) {
    t4 = /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
      children: [t2, /*#__PURE__*/jsxRuntime.jsxs(index.ActionList.Group, {
        ...props,
...
const GroupExpand = /*#__PURE__*/React__default.default.forwardRef((t0, forwardedRef) => {
  ...
  if ($[6] !== amountToShow || $[7] !== currentPage || $[8] !== focusTargetIndex || $[9] !== groupId || $[10] !== items || $[11] !== renderItem) {
    t3 = currentPage > 0 ? /*#__PURE__*/jsxRuntime.jsx(jsxRuntime.Fragment, {
  ...
  if ($[13] !== currentPage || $[14] !== forwardedRef || $[15] !== groupId || $[16] !== label || $[17] !== pages || $[18] !== props) {
    t4 = currentPage < pages || currentPage === 0 ? /*#__PURE__*/jsxRuntime.jsxs(index.ActionList.Item, {
      as: "button",
      "aria-expanded": "false",
      ref: forwardedRef,
      onSelect: () => {
...
const GroupHeading = t0 => {
  ...
  let t4;
  if ($[6] !== as || $[7] !== rest || $[8] !== t3) {
    t4 = /*#__PURE__*/jsxRuntime.jsx(index.ActionList.GroupHeading, {
      as: as,
      sx: t3,
...
function _temp(child) {
  return /*#__PURE__*/React.isValidElement(child) && child.type === SubNav;
}
function _temp2(child_0) {
  return /*#__PURE__*/React.isValidElement(child_0) ? child_0.type !== SubNav && child_0.type !== TrailingAction : true;
}
