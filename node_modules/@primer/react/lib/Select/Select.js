...
const ArrowIndicatorSVG = t0 => {
  ...
  if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
    t1 = /*#__PURE__*/jsxRuntime.jsx("path", {
  ...
  let t2;
  if ($[1] !== className) {
    t2 = /*#__PURE__*/jsxRuntime.jsx("svg", {
      "aria-hidden": "true",
      width: "16",
      height: "16",
      fill: "currentColor",
...
const ArrowIndicator = t0 => {
  ...
  let t1;
  if ($[0] !== className) {
    t1 = clsx.clsx(Select_module.ArrowIndicator, className);
    $[0] = className;
    $[1] = t1;
  } else {
    t1 = $[1];
  ...
  let t2;
  if ($[2] !== t1) {
    t2 = /*#__PURE__*/jsxRuntime.jsx(ArrowIndicatorSVG, {
      className: t1
    });
    $[2] = t1;
    $[3] = t2;
...
const Option = props => {
  ...
  let t0;
  if ($[0] !== props) {
    t0 = /*#__PURE__*/jsxRuntime.jsx("option", {
      ...props
    });
    $[0] = props;
    $[1] = t0;
...
const OptGroup = props => {
  ...
  let t0;
  if ($[0] !== props) {
    t0 = /*#__PURE__*/jsxRuntime.jsx("optgroup", {
      ...props
    });
    $[0] = props;
    $[1] = t0;
