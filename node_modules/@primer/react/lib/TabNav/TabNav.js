...
var TabNav_module = require('./TabNav.module.css.js');
...
function TabNav(t0) {
  ...
  const {
    containerRef: navRef
  } = useFocusZone.useFocusZone(t5, t6);
  const t7 = navRef;
  let t8;
  if ($[11] !== children) {
    t8 = /*#__PURE__*/jsxRuntime.jsx("div", {
      role: "tablist",
      className: TabNav_module.TabNavTabList,
      children: children
    });
    $[11] = children;
    $[12] = t8;
  ...
  if ($[13] !== ariaLabel || $[14] !== t8) {
    t9 = /*#__PURE__*/jsxRuntime.jsx("nav", {
      "aria-label": ariaLabel,
      className: TabNav_module.TabNavNav,
      children: t8
    });
    $[13] = ariaLabel;
    $[14] = t8;
 ...
 * @deprecated
 */
const TabNavLink = /*#__PURE__*/React__default.default.forwardRef(function TabNavLink(t0, ref) {
  ...
  const t4 = selected && TabNav_module.Selected;
  let t5;
  if ($[5] !== className || $[6] !== t3 || $[7] !== t4) {
    t5 = clsx.clsx("TabNav-item", TabNav_module.TabNavLink, t3, t4, className);
    $[5] = className;
    $[6] = t3;
    $[7] = t4;
    $[8] = t5;
