...
const Root = props => {
  ...
  let t1;
  if ($[1] !== props) {
    t1 = /*#__PURE__*/jsxRuntime.jsx(PageLayout.PageLayout, {
      containerWidth: "full",
      padding: "none",
      columnGap: "none",
      rowGap: "none",
...
const Header = t0 => {
  ...
  if ($[4] !== divider || $[5] !== padding || $[6] !== props) {
    t3 = /*#__PURE__*/jsxRuntime.jsx(PageLayout.PageLayout.Header, {
      padding: padding,
      divider: divider,
      ...props
    });
...
const Content = t0 => {
  ...
  if ($[4] !== padding || $[5] !== props || $[6] !== width) {
    t3 = /*#__PURE__*/jsxRuntime.jsx(PageLayout.PageLayout.Content, {
      width: width,
      padding: padding,
      ...props
    });
...
const Pane = t0 => {
  ...
  if ($[6] !== divider || $[7] !== padding || $[8] !== position || $[9] !== props || $[10] !== sticky) {
    t5 = /*#__PURE__*/jsxRuntime.jsx(PageLayout.PageLayout.Pane, {
      position: position,
      sticky: sticky,
      padding: padding,
      divider: divider,
...
const Footer = t0 => {
  ...
  let t3;
  if ($[4] !== divider || $[5] !== padding || $[6] !== props) {
    t3 = /*#__PURE__*/jsxRuntime.jsx(PageLayout.PageLayout.Footer, {
      padding: padding,
      divider: divider,
      ...props
    });
